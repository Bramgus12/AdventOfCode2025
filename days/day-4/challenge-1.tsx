...
import { completeChallenge1 } from "@/days/day-4/actions";
import z from "zod";
...
export default function Day4Challenge1() {
    ...
    return (
        <>
            <Challenge
                ...
                description={
                    "Find all amount of paper rolls that have fewer than 4 adjacent paper rolls."
                }
