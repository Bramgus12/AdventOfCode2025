...
import { completeChallenge1 } from "@/days/day-6/actions";

const schema = z.string();

export default function Day6Challenge1() {
    ...
    return (
        <Challenge
            ...
            description={
                "Do all the math operations in the file and return the final result."
            }
